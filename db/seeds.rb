...
classmates = Theme.create!(name: "Classmates", user: enzo)
batch_308 = Deck.create!(name: "Batch 308", rank: 1, parent: nil, theme: classmates, original_owner: true)
...
Card.create!(term: "Joseph", definition: "C'est cool ? 👍", vitality: 0, deck: batch_308, photo: "https://avatars3.githubusercontent.com/u/5313828?v=4")
Card.create!(term: "Kévin", definition: "Il met des paillettes dans ton code", vitality: 0, deck: batch_308, photo: "https://avatars1.githubusercontent.com/u/472453?v=4")

Card.create!(term: "Benjamin", definition: "Pongiste du dimanche", vitality: 0, deck: batch_308, photo: "https://avatars2.githubusercontent.com/u/40176179?v=4")
Card.create!(term: "John", definition: "Le roi du tact", vitality: 0, deck: batch_308, photo: "https://avatars3.githubusercontent.com/u/55751653?v=4")
Card.create!(term: "Nicolas", definition: "Toujours hydraté", vitality: 0, deck: batch_308, photo: "https://avatars3.githubusercontent.com/u/54436066?v=4")
Card.create!(term: "Axel", definition: "CSS master", vitality: 0, deck: batch_308, photo: "https://avatars2.githubusercontent.com/u/55686820?v=4")
Card.create!(term: "Matthieu", definition: "On l'applaudit s'il vous plaît", vitality: 0, deck: batch_308, photo: "https://res.cloudinary.com/wagon/image/upload/c_fill,g_face,h_200,w_200/hxlk3f4cdqu6znvsxtcy.jpg")
